...
exports.BuyerProfileSchema = zod_1.default.object(__assign(__assign(__assign(__assign(__assign(__assign({ id: zod_1.default.number() }, exports.BusinessInfoSchema.shape), exports.AddressInfoSchema.shape), exports.ContactInfoSchema.shape), exports.BusinessDocumentsSchema.shape), exports.BankingInfoSchema.shape), { userId: zod_1.default.number(), createdAt: zod_1.default.date(), updatedAt: zod_1.default.date() }));
