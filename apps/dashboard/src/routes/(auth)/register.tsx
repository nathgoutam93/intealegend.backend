...
import SellerLoginModal from "@/components/seller-login-modal";
import SellerRegistrationForm from "@/components/register-form";
        ...
        <section className="relative bg-gradient-to-br from-green-900 to-emerald-800 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="hidden text-xl text-green-100 max-w-2xl mx-auto mb-8">
